...
const BmiCalculator = () => {
  ...
  return (
    <div className=' h-auto lg:max-h-screen'>

      <section class="bg-gray-900 lg:max-h-[40%]">
        <div
          class="mx-auto max-w-screen-xl px-4 py-11  lg:flex lg:items-center"
        >
          <div class="mx-auto max-w-full text-center">
            <h1 class="bg-gradient-to-r from-green-300 via-red-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl lg:p-4">
            BMI calculator
              <strong class="font-bold text-white block text-sm sm:text-2xl">
      ...
      <div className="container lg:max-h-[40%]">
        <div className="row">
